...
export type OptionInputDecoratorFactory<O extends SupportedOptionTypes, T extends Decorators> = (
  options?: O,
) => T
...
/** Describes a factory that takes an option. */
export type TypeOptionInputMethodDecoratorFactory<O extends SupportedOptionTypes> =
