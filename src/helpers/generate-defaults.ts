...
/**
 * Finds the default value attached to a `ZodDefault` or `ZodPrefault` nested inside any combination
 * of identity-preserving wrappers (`ZodOptional`, `ZodNullable`, `ZodReadonly`, `ZodCatch`,
 * `ZodLazy`).
 *
